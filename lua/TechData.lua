...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.BuildMenu,             [kTechDataDisplayName] = "Build", [kTechDataHotkey] = Move.Q, [kTechDataTooltipInfo] = "Basic structures"},
        { [kTechDataId] = kTechId.AdvancedMenu,          [kTechDataDisplayName] = "Advanced", [kTechDataHotkey] = Move.W, [kTechDataTooltipInfo] = "Advanced structures"},
        { [kTechDataId] = kTechId.AssistMenu,            [kTechDataDisplayName] = "Assist", [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "Assist players"},
        { [kTechDataId] = kTechId.SquadMenu,             [kTechDataDisplayName] = "Squad", [kTechDataHotkey] = Move.R, [kTechDataTooltipInfo] = "Squad orders"},
        ...
        { [kTechDataId] = kTechId.MedPack,               [kTechDataMapName] = MedPack.kMapName,                  [kTechDataDisplayName] = "Med pack",            [kTechDataCostKey] = kMedPackCost,             [kTechDataModel] = MedPack.kModelName, [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = string.format("Restores %d player health", MedPack.kHealth)},
        ...
        { [kTechDataId] = kTechId.RoboticsFactory,       [kTechDataDisplayName] = "Robotics Factory",         [kTechDataMapName] = RoboticsFactory.kMapName,          [kTechDataDisplayName] = "Robotics Factory", [kTechDataImplemented] = false,    [kTechDataCostKey] = kRoboticsFactoryCost,       [kTechDataModel] = RoboticsFactory.kModelName,    [kTechDataEngagementDistance] = kRoboticsFactorEngagementDistance,        [kTechDataBuildTime] = kRoboticsFactoryBuildTime, [kTechDataMaxHealth] = kRoboticsFactoryHealth,    [kTechDataMaxArmor] = kRoboticsFactoryArmor, [kTechDataPointValue] = kRoboticsFactoryPointValue, [kTechDataHotkey] = Move.R, [kTechDataNotOnInfestation] = true, [kTechDataTooltipInfo] = "Allows production of mobile siege cannons"},        
        ...
        { [kTechDataId] = kTechId.Exoskeleton,           [kTechDataDisplayName] = "Exoskeletons", [kTechDataMapName] = "Exoskeleton", [kTechDataImplemented] = false,               [kTechDataCostKey] = kExoskeletonCost, [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "Allows Exoskeletons (heavies) to be purchased" },
        ...
        { [kTechDataId] = kTechId.Weapons2,              [kTechDataCostKey] = kWeapons2ResearchCost,                 [kTechDataResearchTimeKey] = kWeapons2ResearchTime,     [kTechDataDisplayName] = "Weapons #2 (Unlocks Shotgun Upgrade)", [kTechDataHotkey] = Move.Z, [kTechDataTooltipInfo] = string.format("Marine weapons do %d%% extra damage", math.ceil((kWeapons2DamageScalar - 1)*100)) },
        ...
        { [kTechDataId] = kTechId.Crag,                  [kTechDataMapName] = Crag.kMapName,                         [kTechDataDisplayName] = "Crag",  [kTechDataCostKey] = kCragCost,     [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kCragBuildTime, [kTechDataModel] = Crag.kModelName,           [kTechDataMaxHealth] = kCragHealth, [kTechDataMaxArmor] = kCragArmor,   [kTechDataInitialEnergy] = kCragInitialEnergy,      [kTechDataMaxEnergy] = kCragMaxEnergy, [kTechDataPointValue] = kCragPointValue, [kStructureVisualRange] = Crag.kHealRadius, [kTechDataTooltipInfo] = "Heals friendly units and allows defensive upgrades (automatic)", [kTechDataGrows] = true},
        ...
        { [kTechDataId] = kTechId.Melee1Tech,                  [kTechDataDisplayName] = string.format("Attack #1", math.floor((kMelee1DamageScalar - 1)*100)), [kTechDataHotkey] = Move.M, [kTechDataCostKey] = kMelee1ResearchCost, [kTechDataResearchTimeKey] = kMelee1ResearchTime},        
        { [kTechDataId] = kTechId.Melee2Tech,                  [kTechDataDisplayName] = string.format("Attack #2 (Unlocks Lerk/Fade)", math.floor((kMelee2DamageScalar - 1)*100)), [kTechDataCostKey] = kMelee2ResearchCost, [kTechDataResearchTimeKey] =  kMelee2ResearchTime},        
        { [kTechDataId] = kTechId.Melee3Tech,                  [kTechDataDisplayName] = string.format("Attack #3", math.floor((kMelee3DamageScalar - 1)*100)), [kTechDataHotkey] = Move.M, [kTechDataCostKey] = kMelee3ResearchCost, [kTechDataResearchTimeKey] =  kMelee3ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor1Tech,             [kTechDataDisplayName] = string.format("Armor #1", math.floor((kAlienArmor1 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor1ResearchCost, [kTechDataResearchTimeKey] = kAlienArmor1ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor2Tech,             [kTechDataDisplayName] = string.format("Armor #2", math.floor((kAlienArmor2 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor2ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor2ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor3Tech,             [kTechDataDisplayName] = string.format("Armor #3", math.floor((kAlienArmor3 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor3ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor3ResearchTime},
