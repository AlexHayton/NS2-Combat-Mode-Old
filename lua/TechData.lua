...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.AlienArmor1Tech,             [kTechDataDisplayName] = string.format("Armor #1 (+%.2f%% armor absorption)", math.floor((kAlienArmor1 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor1ResearchCost, [kTechDataResearchTimeKey] = kAlienArmor1ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor2Tech,             [kTechDataDisplayName] = string.format("Armor #2 (+%.2f%% armor absorption)", math.floor((kAlienArmor2 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor2ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor2ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor3Tech,             [kTechDataDisplayName] = string.format("Armor #3 (+%.2f%% armor absorption)", math.floor((kAlienArmor3 - 1)*100)), [kTechDataHotkey] = Move.A, [kTechDataCostKey] = kAlienArmor3ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor3ResearchTime},
