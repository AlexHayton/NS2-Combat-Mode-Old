...
function GUIWaypoints:Initialize()
    ...
    self.finalWaypoint = GUI.CreateGraphicsItem()
    ...
    self.finalDistanceText = GUI.CreateTextItem()
    ...
    self.finalDistanceText:SetTextAlignmentX(GUITextItem.Align_Center)
    self.finalDistanceText:SetTextAlignmentY(GUITextItem.Align_Min)
    self.finalWaypoint:AddChild(self.finalDistanceText)
    
    self.finalNameText = GUI.CreateTextItem()
    ...
    self.finalNameText:SetTextAlignmentX(GUITextItem.Align_Center)
    self.finalNameText:SetTextAlignmentY(GUITextItem.Align_Min)
    self.finalNameText:SetPosition(Vector(0, GUIWaypoints.kDistanceFontSize, 0))
    self.finalWaypoint:AddChild(self.finalNameText)
    
    self.nextWaypoint = GUI.CreateGraphicsItem()
    ...
    self.nextDistanceText = GUI.CreateTextItem()
    ...
    self.nextDistanceText:SetTextAlignmentX(GUITextItem.Align_Center)
    self.nextDistanceText:SetTextAlignmentY(GUITextItem.Align_Min)
