...
GUIAlienHUD.kExperienceBackgroundTextureY2 = 128
...
function GUIAlienHUD:CreateEnergyBall()
    ...
    self.activeAbilityIcon = GUI.CreateGraphicsItem()
    ...
    self.secondaryAbilityBackground = GUI.CreateGraphicsItem()
    ...
    self.secondaryAbilityIcon = GUI.CreateGraphicsItem()
...
function GUIAlienHUD:CreateInactiveAbilityIcons(numberOfIcons)
    ...
    self.inactiveAbilitiesBar = GUI.CreateGraphicsItem()
    ...
    while currentIcon < numberOfIcons do
        ...
        local iconBackground = GUI.CreateGraphicsItem()
        ...
        local inactiveIcon = GUI.CreateGraphicsItem()
        ...
        local numberIndicatorText = GUI.CreateTextItem()
        ...
        numberIndicatorText:SetTextAlignmentX(GUITextItem.Align_Center)
        numberIndicatorText:SetTextAlignmentY(GUITextItem.Align_Max)
