...
function OnCommandScores(scoreTable)
    Scoreboard_SetPlayerData(scoreTable.clientId, scoreTable.entityId, scoreTable.playerName, scoreTable.teamNumber, scoreTable.score, scoreTable.kills, scoreTable.deaths, scoreTable.resources, scoreTable.isCommander, scoreTable.status, scoreTable.isSpectator)
end
