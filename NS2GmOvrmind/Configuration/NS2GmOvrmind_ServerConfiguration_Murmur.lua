--[[ NS2-GmOvrmind(v10) Murmur (Server-)Configuration
 ----------------------------------------------------
...
--[[----------------------
 ...
 ---------------------]]--
	...
	--[[ Enable NS2-GmOvrmind's built-in Mumble-server(Murmur)
	 In: BOOLEAN Enable (Default: true)
	 Out: Nill ]]--
	--NS2GmOvrmind.Murmur.SetEnabled(true); -- Work in progress, do not uncomment